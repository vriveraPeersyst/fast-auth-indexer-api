...
@Index("fastauth_user_health_tx_pkey", ["txHash"], { unique: true })
@Index("fastauth_user_health_tx_block_outcome_idx", ["blockTimestamp", "outcome"], {})
@Index("fastauth_user_health_tx_outcome_attempted_idx", ["outcome", "lastAttemptedAt"], {})
@Entity("fastauth_user_health_tx", { schema: "public" })
export class FastAuthUserHealthTx {
